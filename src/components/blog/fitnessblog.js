            ...
            <div className="more-articles-section">
                ...
                {actualData.recentFitness.map(items=>(
                    <div data-aos="fade-up" key={items.num} className="more-page-content">
                        ...
                        <h3><Link onClick={()=>{navigate(`/category/technology/${items.title}`); window.location.reload();}} to={`/category/fitness/${items.title}`} className="title-links">{items.title}</Link></h3>
